...
def convert_image_to_svg():
    ...
    # Get optional num_colors parameter (default: 8)
    ...
    # Call the conversion function with num_colors parameter
    result = image_to_svg.image_to_svg(input_path, output_path, num_colors=num_colors)
    ...
    if result['success']:
        ...
        if 'colors_traced' in result:
            response_data['colors_traced'] = result['colors_traced']
        if 'method' in result:
